...
status/vd17_auth_db.loaded: data/output/vd17/vd17_auth.tsv.gz
	...
	touch status/vd17_auth_db.loaded
...
status/vd17_auth.fetched: status/vd17_db.loaded
	python src/fetch-auths.py -u hsci -h vm2505.kaj.pouta.csc.fi -d vd17 -p ${SQL_PASSWORD} -t vd17 -e data/work/vd17_auth/fetch_errors.txt -o data/work/vd17_auth/vd17_auth.mrcx.gz
	touch status/vd17_auth.fetched
